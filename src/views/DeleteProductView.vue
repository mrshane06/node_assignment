          ...
          <div class="col-lg-8 offset-lg-2">
            <div class="main-content-area">
              ...
              <form @submit.prevent="updateProduct">
                ...
                <button @click="deleteProduct" class="main-border-button">Delete Product</button>
              </form>
            </div>
          </div>
        </div>
...
async fetchProduct() {
  ...
  try {
    ...
    async deleteProduct() {
      ...
      console.log('Attempting to delete product with ID:', this.product.product_id); // Debugging line
      try {
        await axios.delete(`https://node-assignment-1-nfwz.onrender.com/products/${this.product.product_id}`);
        console.log('Product deleted successfully:'); // Debugging line
